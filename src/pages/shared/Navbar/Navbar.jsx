        ...
        <div className="navbar bg-base-100 mt-5 px-10 ">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost normal-case text-xl hidden md:block">
                    {/* <img className="w-16 h-7 md:w-40 md:h-14" src="https://i.ibb.co/tqfQF9z/Whats-App-Image-2023-10-21-at-20-00-07-b7ca9520-removebg-preview.png" alt="" /> */}
                    <img className="w-24 h-7 md:w-56 md:h-16" src="https://i.ibb.co/d6qHMQ4/gbg.png" alt="" />
                </a>
